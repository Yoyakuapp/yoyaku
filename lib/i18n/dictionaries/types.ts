export type Dictionary = {
  ...
  admin: {
    ...
    payment: {
      ...
      subtitle: string;
      loading: string;
      stripeSectionHeading: string;
      stripeConnectedBadge: string;
      stripePendingBadge: string;
      stripeNotConnectedBadge: string;
      stripeWhatIsIt: string;
      stripeHowItWorks: string;
      stripeOptionalNote: string;
      stripeAgreeCheckboxLabel: string;
      stripeAgreeRequiredHint: string;
      ...
      depositSectionHeading: string;
      depositExplainOn: string;
      depositExplainOff: string;
      depositNoNeedHint: string;
      depositOptionOff: string;
      depositOptionOn: string;
      depositRequiresStripeHint: string;
      depositRequiresCancellationPolicyError: string;
      cancellationPolicyHeading: string;
      cancellationPolicyDescription: string;
      cancellationPolicyRequiredNote: string;
    ...
    dashboard: {
      ...
      bookingsListButtonDescription: string;
      scheduleButton: string;
      scheduleButtonDescription: string;
      staffButton: string;
      staffButtonDescription: string;
      menuButton: string;
      menuButtonDescription: string;
      storeButton: string;
      storeButtonDescription: string;
      paymentButton: string;
      paymentButtonDescription: string;
      salesButton: string;
      salesButtonDescription: string;
      customersButton: string;
      customersButtonDescription: string;
      networkButton: string;
      networkButtonDescription: string;
      accountButton: string;
      accountButtonDescription: string;
    };
  };
};
